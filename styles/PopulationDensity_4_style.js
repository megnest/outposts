...
var style_PopulationDensity_4 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Pp_Dnst");
    var labelText = "";
    size = 0;
    ...
    if (value >= 0.000000 && value <= 13.620000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 13.620000 && value <= 41.680000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 41.680000 && value <= 131.250000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 131.250000 && value <= 1116.050000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1116.050000 && value <= 152562.170000) {
            style = [ new ol.style.Style({
